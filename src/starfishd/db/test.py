...
class video_singal_query_testcase(unittest.TestCase):
    def setUp(self):
        ...
        db.new_video('simsun', 'test123', self.SHA1, 'title1', 'spot1', '/video/1.mp4')
        db.new_video('simsun', 'video1', self.SHA1+'A', 'title2', 'spot2', '/video/2.mp4')
        db.new_video('simsun', 'video2', self.SHA1+'B', 'title3', 'spot3', '/video/3.mp4')
        db.new_video('simsun', 'video3', self.SHA1+'C', 'title4', 'spot5', '/video/4.mp4')
        db.new_video('juncheng', 'video1', self.SHA1+'D', 'title5', 'spot6', '/video/5.mp4')
        db._new_video('juncheng', 'video_juncheng', self.SHA1+'E')
        db.new_video('tyler', 'video', self.SHA1+'EF', 'title', 'spot1', '/video/6.mp4')
        db.new_video('tyler', 'video', self.SHA1+'F', 'title', 'spot2', '/video/7.mp5')
